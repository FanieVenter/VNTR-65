...
### 15:00 - 21:00
I have refined the journal and the project setup to be more complient/in line with what the keeb docs expect including adding more screenshots and images to the gallery adding the hours i worked in the journal and adding a BOM in both PDF and CSV format. I also added a concept image to the readme as well as a logo for the project. Updated the Threads drawing. Created a new render of the keyboard with the updated pcb after moving the usb c port so that its centered. I also created a logo for the project and added it to the readme. I also created a silkscreen graphic and added it to the pcb. I might also engrave it in the case.
## Jul 17
### 10:00 - 16:00
